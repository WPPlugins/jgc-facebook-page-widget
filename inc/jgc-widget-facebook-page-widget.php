...
class jgcfpp_widget_facebook_page extends WP_Widget {
	...
	function form ($instance) {
        ...
        <p><a style="font-style: italic; color:#919191; text-decoration: none;" href="http://galussothemes.com/wordpress-themes" target="_blank"><?php _e('Take a look to our Themes', 'jgc-facebook-page-widget'); ?> &raquo;</a></p><hr>
       <?php
	}
